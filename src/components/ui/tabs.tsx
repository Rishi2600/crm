...
// Local edit to the shadcn/ui source: the active tab is marked with a
// hairline border instead of a shadow (the design uses no shadows). Every
// trigger carries a transparent border so selecting one shifts nothing.
