...
//     setPipeline((prev) => prev.map((d) => (d.id === draggedId ? { ...d, stage: newStage } : d)));
...
//       if (!res.ok) {
//         setPipeline(previousPipeline); // roll back
//         setError("Failed to move deal. Please try again.");
//       } else {
//         fetchPipeline(); // refresh summary counts/totals to match new stage
//       }
//     } catch {
